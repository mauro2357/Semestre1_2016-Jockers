...
public class LaboratoriosAgregar extends BloquesPrincipal {
	...
	public LaboratoriosAgregar(String nombre_bloque, String lab_nombre, String horario_nombre, String lab_descripcion, String lab_videobeam){
		super(nombre_bloque);
		this.lab_nombre=lab_nombre;
		this.horario_nombre=horario_nombre;
		this.lab_descripcion=lab_descripcion;
